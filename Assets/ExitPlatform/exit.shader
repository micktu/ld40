...
Shader "Shader Forge/exit" {
    Properties {
        ...
        _Additionalbrightness ("Additional brightness", Range(0, 1)) = 0.2820513
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _Additionalbrightness;
            struct VertexInput {
...
////// Emissive:
                ...
                float3 emissive = (lerp((lerp(saturate(tex2D( _GrabTexture, node_5682).rgb),_Color.rgb,node_3203)*node_4322),(_node_1650_var.rgb*_Color.rgb),_node_1650_var.r)+_Additionalbrightness);
